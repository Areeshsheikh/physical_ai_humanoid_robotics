...
1. **[Vision-Language Models](./multi-modal.md)** - Integration of vision-language models for scene understanding
2. **[Voice Command Processing](./voice-to-action.md)** - Processing and understanding natural language commands
...
5. **[Autonomous Humanoid Systems](./capstone.md)** - Building complete autonomous humanoid systems
